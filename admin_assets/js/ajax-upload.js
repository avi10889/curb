var site_url = 'http://localhost/curbsidefilms/'
var admin_panel = 'content_admin';
jQuery(document).ready(function () {
				...
				function load_images(preview_area,page,type)
				{
					$("#"+preview_area).load(site_url+admin_panel+'/pages/get_image_list/'+page+'/'+type);
					console.log(site_url+admin_panel+'/pages/get_image_list/'+page+'/'+type);
				}
				...
				function ajax_upload(files) {					
					...
					$.ajax({
						url : "/curbsidefilms/content_admin/pages/upload_section_img", // Change name according to your php script to handle uploading on server
						type : 'post',
						data : formData,
						dataType : 'json',						
						processData: false,
						...
						success : function(json){
							...
							$('#img-preview').html(json.img);
							//load_images('img_preview','home','section');															
							if(json.error != '') 
